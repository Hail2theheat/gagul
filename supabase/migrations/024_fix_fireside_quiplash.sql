-- =====================================================
-- FIX: quiplash_assignments.response_id doesn't exist
-- Run this in Supabase Dashboard -> SQL Editor
-- =====================================================

-- Fix get_fireside_data to correctly join quiplash data
...
BEGIN
  ...
  FROM (
    SELECT jsonb_build_object(
      ...
      -- Join quiplash_assignments with responses through user_id + group_prompt_id
      'quiplash_data', CASE
