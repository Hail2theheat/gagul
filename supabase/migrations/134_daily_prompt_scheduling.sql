-- =====================================================
-- DAILY PROMPT SCHEDULING AT 3:01 AM EST
-- Prompts go live at 3:01 AM EST, expire at 3:00 AM EST next day
-- =====================================================

-- Update schedule_daily_prompt to use fixed 3:01 AM EST time
...
-- Schedule daily prompt cron job at 3:01 AM EST = 8:01 AM UTC
-- Note: During DST (Mar-Nov), this runs at 4:01 AM EDT. Adjust to '1 7 * * *' when DST starts.
SELECT cron.schedule(
  'schedule-daily-prompts',
  '1 8 * * *',
  $$
  SELECT schedule_all_groups();
  $$
);
