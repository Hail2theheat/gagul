    ...
    <>
      ...
      <View style={{ backgroundColor: CARD, borderColor: BORDER, borderWidth: 1, borderRadius: Radii.lg, padding: Spacing.lg, marginBottom: 14 }}>
          ...
          <View style={{ flex: 1 }}>
            {editingUsername ? (
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                ...
                >
                  <Text style={{ color: "#000", fontFamily: "Nunito_700Bold", fontSize: 12 }}>{saving ? "..." : "Save"}</Text>
                </Pressable>
              </View>
            ) : (
              <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", marginTop: 6 }}>
              ...
              <Text style={{ color: CampfireColors.WARNING, fontSize: 13, fontFamily: "Nunito_600SemiBold" }}>{profile?.total_points || 0} points</Text>
            </View>
          </View>
        </View>
        ...
        >
          ...
          <Text style={{ color: TEXT, fontFamily: "Nunito_600SemiBold", marginLeft: 8 }}>Edit Avatar</Text>
        </Pressable>
      </View>
      ...
      <Modal visible={showEmojiPicker} transparent animationType="fade" onRequestClose={() => setShowEmojiPicker(false)}>
        ...
        >
          <View style={{ backgroundColor: CARD, borderRadius: Radii.modal, padding: Spacing.xl, width: "85%", maxWidth: 320 }}>
            ...
            >
              <Text style={{ color: MUTED, fontFamily: "Nunito_600SemiBold" }}>Cancel</Text>
            </Pressable>
          </View>
        </Pressable>
      </Modal>
